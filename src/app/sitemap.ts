...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const frStatic: MetadataRoute.Sitemap = [
    ...
    // Page outil « Empreinte d'une requête IA », générée hors Next par le
    // sous-projet empreinte-ia/ du dépôt (npm run build:empreinte, enchaîné
    // par npm run build), qui écrit public/empreinte-ia/ avec son llms.txt
    // dédié. Pas de version anglaise : décision MESURÉE du 15/08/2026
    // (volumes US en chute de ~75 % entre S2 2025 et S1 2026, SERP tenue par
    // Epoch AI/IEEE/grands médias, intention hors doctrine de la section EN).
    // Détail : empreinte-ia/CLAUDE.md.
