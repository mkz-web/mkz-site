...
- [Audit SEO gratuit en ligne](${SITE}/audit-seo/): outil en libre-service, 20 mesures réelles faites sur le site au moment du test (HTTPS, indexabilité, vraie 404, balises SERP, robots des moteurs IA, llms.txt, données structurées JSON-LD), score sur 100 et priorités de correction. Gratuit, sans inscription
- [Outils gratuits](${SITE}/outils/): hub des deux outils en libre-service (audit SEO + IA, simulateur d'empreinte d'une requête IA), sans inscription
...
- [Free SEO & AI visibility audit](${SITE}/en/seo-audit/): self-service tool, 20 real checks run on the site at test time (HTTPS, indexability, real 404, SERP tags, AI crawlers, llms.txt, JSON-LD structured data), score out of 100 and fix priorities. Free, no signup
