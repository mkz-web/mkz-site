...
export const metadata: Metadata = createMetadata("en", {
  ...
  description:
    "How MKZ handles your personal data: what the contact form collects, why, for how long, and how to exercise your GDPR rights. The French version is the binding one.",
