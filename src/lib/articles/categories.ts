...
export const categories: Category[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      "Ce cocon rassemble nos guides sur le **référencement IA**, aussi appelé GEO (Generative Engine Optimization) : autoriser les robots des IA, produire des faits citables, mesurer si vous êtes réellement repris. L'actualité du cocon : depuis le 22 juillet 2026, les Aperçus IA de Google sont en France, et nous avons relevé [ce que ça change pour un artisan](/conseils/referencement-ia/ai-overviews-france/), recherche par recherche. Un outil gratuit pour toucher le sujet du doigt : l'[audit SEO + IA](/audit-seo/), qui dit en une minute si les robots des IA vous lisent. Pour déléguer, voyez notre service de [référencement IA](/referencement-ia/).",
    ],
    icon: "🤖",
